...
//设置标题栏的背景颜色
#define DefaultTitleViewColor DefaultBackgroundColor;
//设置正常状态下的按钮颜色（只支持RGB）
...
/*********************自定义underline*******************/
#define DefaultTopUnderLineH 2 //高度
#define DefaultTopUnderLineW 50 //宽度
#define DefaultTopUnderLineColor [UIColor whiteColor] //颜色
...
- (void)selectButon:(UIButton *)button {
    //取消原来的选中
    [self.selButton setTitleColor:DefaultButtonColorNormal forState:UIControlStateNormal];
    self.selButton.transform = CGAffineTransformIdentity;
    //选中点击的按钮
    [button setTitleColor:DefaultButtonColorSelected forState:UIControlStateNormal];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.underLine.CC_centerX = button.CC_centerX;
    }];
...
- (void)setupUnderLine {
    ...
    underLine.backgroundColor = DefaultTopUnderLineColor;
    underLine.frame = CGRectMake(0, TopViewH - DefaultTopUnderLineH, DefaultTopUnderLineW, DefaultTopUnderLineH);
